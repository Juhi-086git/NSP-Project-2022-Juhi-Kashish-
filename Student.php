...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO Student (Name, Reg_Id, Email_ID, Phone_Num, Sec, Sem, Inst_Name, Department, Session, Platform, Duration, Credit, File, Date_Time) VALUES ('$Name', '$Reg_Id', '$Email_ID', '$Phone_Num', '$Sec', '$Sem', '$Inst_Name', '$Department', '$Session', '$Platform', '$Duration', '$Credit', '$File', current_timestamp())";
...
<body>
    ...
    if ($insert) {
        echo ' <div class="alert alert-success alert-dismissible fade show" role="alert">
            <strong>Your response have been succesffully Submitted</strong> 
    ...
    if ($notinsert) {
        echo ' <div class="alert alert-danger alert-dismissible fade show" role="alert">
                <strong>Oops!</strong> ' . 'You might have entered details incorrectly.' . '
                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div> ';
    ...
    <div>
        <div class="container">
            <h1>ENTER YOUR DETAILS AS STUDENT</h1>
            <br>
        </div>
        <form action="Student.php" method="POST">
            ...
            <input type="text" id="Sec" name="Sec" placeholder="Your Section.." required>
            <br>
            ...
            <input type="file" id="MyFile" name="File" required><br><br>
